...
if ($codigo != ""){
    $resultado = escuela::checkCodigoRegistro($codigo);
    ...
    if($resultado > 0){
        ...
        $json_string = json_encode(array("estado" => 1,"mensaje" => "Codigo aceptado, puede continuar con el registro.")); //Preparamos el mensaje a enviar como respuesta
